		...
		'attr'=>array(
			'general' => array(
				...
				'text'=>array(
					...
					'desc' => Text::_('COM_SPPAGEBUILDER_ADDON_CONTENT_LABEL_DESC'),
				...
				'dropcap'=>array(
					...
					'desc'=>Text::_('COM_SPPAGEBUILDER_ADDON_DROPCAP_DESC'),
					'std'=>0
				),
				...
				'dropcap_font_size'=>array(
					'type'=>'slider',
					'title'=>Text::_('COM_SPPAGEBUILDER_ADDON_DROPCAP_FONT_SIZE'),
					'desc'=>Text::_('COM_SPPAGEBUILDER_ADDON_DROPCAP_FONT_SIZE_DESC'),
					'depends'=>array(array('dropcap', '=', 1)),
					'min'=> 0,
					'max'=> 200,
					'responsive'=> true,
