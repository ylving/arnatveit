	...
	array(
		...
		'attr'=>array(
			'general' => array(
				...
				'hashtag_type' => array(
					'type' => 'select',
					'title' => JText::_('COM_SPPAGEBUILDER_ADDON_INSTAGRAM_HASHTAG_MEDIA_TYPE'),
					'desc' => JText::_('COM_SPPAGEBUILDER_ADDON_INSTAGRAM_HASHTAG_MEDIA_TYPE_DESC'),
					'values' =>array(
						'top' => JText::_('COM_SPPAGEBUILDER_ADDON_INSTAGRAM_HASHTAG_MEDIA_TYPE_TOP'),
						'recent' => JText::_('COM_SPPAGEBUILDER_ADDON_INSTAGRAM_HASHTAG_MEDIA_TYPE_RECENT'),
					),
					'std' => 'top',
					'depends' => array(
						array('item_resource', '=', 'hashtag'),
				...
				'show_stats'=>array(
					...
					'values'=>array(
						'author'	=>JText::_('COM_SPPAGEBUILDER_FIELD_CREATED_BY_LABEL'),
